...
```
  ...
  13. Ter 17/Set: 1º avaliação.
  14. Qui 19/Set: GAM's
       * Script para aula [./scripts/wage.R](./scripts/wage.R).     
  15. Ter 24/Set: SIEPE
  16. Qui 26/Set: SIEPE
  17. Ter 01/Out: Introdução às árvores de regressão: descrição com uma covariável
       * Script para aula [./scripts/intro-trees.R](./scripts/intro-trees.R).     
  18. Qui 03/Out: Árvores de regressão. Árvores com mais de uma covariável e poda
