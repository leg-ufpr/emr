...
```
  ...
  26. Qui 31/Out:(PJ) Modelos com dependência entre observações. Três formas de induzir dependência (transição, marginal e efeitos aleatórios). Introdução aos modelos de efeitos aleatórios
  27. Ter 05/Nov: (PJ/WZ) Modelos de efeitos aleatórios - forma geral, inferência, construção das matrizes. Exemplo. 
